...
class PdfOutputTest extends TestCase
{
    ...
    {
        // HasPdfOutput checks Lang::has("export::pdf.{$type}_title")
        // The namespace prefix is 'export' (the package view/lang namespace)
        app('translator')->addLines(['pdf.pdf_items_title' => 'Custom Items Title'], 'en', 'export');
